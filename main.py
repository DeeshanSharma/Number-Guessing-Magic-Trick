...
# Importing a module to speak the users number
from win32com.client import Dispatch

# Function to speak out the number of user
def speak(line):
    speaker_number = 1
...
# Function to display all the sets to the user and then also managing the results 
...
# Funtion to add to the sum of the users number
def result(lis):
    Sum = lis[0]
    return Sum

# Helper function for the result function
def check(lis, con):
    res = 0
